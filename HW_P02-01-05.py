...
class PlateStackClass:
    ...
    def push_in(self, el):
        ...
        if len(self.elems[len(self.elems)-1]) < self.max_size: # PyCharm ругается на эту строку
    ...
    def get_val(self):
        ...
        [len(self.elems[len(self.elems) - 1])-1]  # PyCharm ругается на эту строку, как на ненужную
...
if __name__ == '__main__':
    ...
    plates.push_in('Plate1') # PyCharm ругается на эту строку
...
#   File "D:\ОблакоОлег\Geek\PyCharm\02\HW_P02-01-05.py", line 71, in <module>
#     plates.push_in('Plate1')
#   File "D:\ОблакоОлег\Geek\PyCharm\02\HW_P02-01-05.py", line 39, in push_in
